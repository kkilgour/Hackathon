...
public class KellyFlightsLengthTest extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(KellyFlightsLengthTestMapper.class);
		job.setReducerClass(KellyFlightsLengthTestReducer.class);
	...
	public static void main(String[] args) throws Exception {
		int result = ToolRunner.run(new Configuration(), new KellyFlightsLengthTest(), args);
		System.exit(result);
	}
}